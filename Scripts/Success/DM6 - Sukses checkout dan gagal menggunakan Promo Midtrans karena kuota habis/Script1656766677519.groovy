...
WebUI.check(findTestObject('promo/promoMidtrans'))
...
WebUI.verifyElementText(findTestObject('Status Payment/quotaFull'), 'Promo quota is fully used')

WebUI.click(findTestObject('QuotaFullDialog/backButton'))
...
WebUI.click(findTestObject('QuotaFullDialog/proceedButton'))
...
WebUI.verifyMatch(actualAmountText, totalAmountText.toString(), false)
